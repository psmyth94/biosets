...
_transformers_available, _transformers_version = _is_package_available(
...
_catboost_available = _is_package_available("catboost")
_coloredlogs_available = _is_package_available("coloredlogs")
# `importlib.metadata.util` doesn't work with `opencv-python-headless`.
_cv2_available = importlib.util.find_spec("cv2") is not None
_datasets_available = _is_package_available("datasets")
_dask_available = _is_package_available("dask")
_dask_ml_available = _is_package_available("dask_ml")
...
_fsspec_available = _is_package_available("fsspec")
try:
    _fsspec_version = importlib.metadata.version("fsspec")
    logger.debug(f"Successfully imported fsspec version {_fsspec_version}")
except importlib.metadata.PackageNotFoundError:
    _fsspec_available = False

_ftfy_available = _is_package_available("ftfy")
_imblearn_available = importlib.util.find_spec("imblearn") is not None
if _imblearn_available:
    try:
        importlib.metadata.version("imbalanced-learn")
    except importlib.metadata.PackageNotFoundError:
...
_ipywidgets_available = _is_package_available("ipywidgets")
...
_lightgbm_available = _is_package_available("lightgbm")
...
_optuna_available = _is_package_available("optuna")
...
_plotly_available = _is_package_available("plotly")
_polars_available = _is_package_available("polars")
_psutil_available = _is_package_available("psutil")
_py3nvml_available = _is_package_available("py3nvml")
_pyctcdecode_available = _is_package_available("pyctcdecode")
_pypdf_available = _is_package_available("pypdf")
_pytesseract_available = _is_package_available("pytesseract")
_pytest_available = _is_package_available("pytest")
_pytorch_quantization_available = _is_package_available("pytorch_quantization")
_ray_available = _is_package_available("ray")
_reportlab_available = _is_package_available("reportlab")
_rjieba_available = _is_package_available("rjieba")
_rpy2_available = _is_package_available("rpy2")
_rpy2_arrow_available = _is_package_available("rpy2_arrow")
_sacremoses_available = _is_package_available("sacremoses")
_safetensors_available = _is_package_available("safetensors")
_scipy_available = _is_package_available("scipy")
_seaborn_available = _is_package_available("seaborn")
...
_pyspark_available = _is_package_available("pyspark")
_smdistributed_available = importlib.util.find_spec("smdistributed") is not None
_soundfile_available = _is_package_available("soundfile")
_spacy_available = _is_package_available("spacy")
_statsmodels_available = _is_package_available("statsmodels")
    ...
    if (
        ...
        if _tf_available:
            if version.parse(_tf_version) < version.parse("2"):
                logger.info(
                    f"TensorFlow found but with version {_tf_version}. GenOmicsML requires version 2 minimum."
                )
                _tf_available = False
    else:
...
def is_torch_sdpa_available():
    ...
    # NOTE: We require torch>=2.1 (and not torch>=2.0) to use SDPA in GenOmicsML for two reasons:
...
def is_dask_ml_available():
    return _dask_ml_available
...
def is_rpy2_available():
    return _rpy2_available


def is_rpy2_arrow_available():
    return _rpy2_arrow_available
...
DASK_IMPORT_ERROR = """
{0} requires the Dask library but it was not found in your environment. You can install it with:
```
pip install dask
```
Please note that you may need to restart your runtime after installation.
...
DASK_ML_IMPORT_ERROR = """
{0} requires the Dask-ML library but it was not found in your environment. You can install it with:
```
pip install dask-ml
```
Please note that you may need to restart your runtime after installation.
...
IMBLEARN_IMPORT_ERROR = """
{0} requires the imbalanced-learn library but it was not found in your environment. You can install it with:
```
...
{0} requires the ipywidgets library but it was not found in your environment. You can install it with:
```
...
{0} requires the seaborn library but it was not found in your environment. You can install it with:
```
pip install seaborn
```
In a notebook or a colab, you can install it by executing a cell with
...
FSSPEC_IMPORT_ERROR = """
{0} requires the fsspec library but it was not found in your environment. You can
install it with:
```
pip install fsspec
```
...
{0} requires the catboost library but it was not found in your environment. You can install it with pip:
`pip install catboost`. Please note that you may need to restart your runtime after installation.
"""
...
# docstyle-ignore
PYPDF_IMPORT_ERROR = """
{0} requires the PyPDF2 library but it was not found in your environment. You can
install it with pip:
```
pip install PyPDF2
```
...
{0} requires the reportlab library but it was not found in your environment. You can
install it with pip:
```
...
{0} requires the matplotlib library but it was not found in your environment. You can install it with pip:
```
...
# docstyle-ignore
POLARS_IMPORT_ERROR = """
{0} requires the polars library but it was not found in your environment. You can install it with pip as
explained here: https://pypi.org/project/polars/.
Please note that you may need to restart your runtime after installation.
"""

# docstyle-ignore
PSUTIL_IMPORT_ERROR = """
{0} requires the psutil library but it was not found in your environment. You can
install it with pip:
```
pip install psutil
```
...
PLOTLY_IMPORT_ERROR = """
{0} requires the plotly library but it was not found in your environment. You can
install it with pip:
```
pip install plotly
```
...
RPY2_IMPORT_ERROR = """
{0} requires the rpy2 library but it was not found in your environment. You can install it with pip:
```
pip install rpy2
```
In a notebook or a colab, you can install it by executing a cell with
...
RPY2_ARROW_IMPORT_ERROR = """
{0} requires the rpy2-arrow library but it was not found in your environment. You can install it with pip:
```
...
{0} requires the statsmodels library but it was not found in your environment. You can install it with pip:
`pip install statsmodels`. Please note that you may need to restart your runtime after installation.
"""
...
{0} requires the lightgbm library. But that was not found in your environment. You can install them with pip:
...
IPYWIDGETS_IMPORT_ERROR = """
{0} requires the ipywidgets library but it was not found in your environment. You can
install it with pip: `pip install ipywidgets`. Please note that you may need to restart
your runtime after installation.
"""

XGBOOST_IMPORT_ERROR = """
{0} requires the xgboost library but it was not found in your environment. You can install it with pip: `pip install
xgboost`. Please note that you may need to restart your runtime after installation.
"""

BACKENDS_MAPPING = OrderedDict(
    [
        ("bs4", (is_bs4_available, BS4_IMPORT_ERROR)),
        ("catboost", (is_catboost_available, CATBOOST_IMPORT_ERROR)),
        ("cv2", (is_cv2_available, CV2_IMPORT_ERROR)),
        ("datasets", (is_datasets_available, DATASETS_IMPORT_ERROR)),
        ("dask", (is_dask_available, DASK_IMPORT_ERROR)),
        ("dask_ml", (is_dask_ml_available, DASK_ML_IMPORT_ERROR)),
        ("detectron2", (is_detectron2_available, DETECTRON2_IMPORT_ERROR)),
        ("essentia", (is_essentia_available, ESSENTIA_IMPORT_ERROR)),
        ("faiss", (is_faiss_available, FAISS_IMPORT_ERROR)),
        ("fsspec", (is_faiss_available, FSSPEC_IMPORT_ERROR)),
        ("flax", (is_flax_available, FLAX_IMPORT_ERROR)),
        ("ftfy", (is_ftfy_available, FTFY_IMPORT_ERROR)),
        ("imblearn", (is_imblearn_available, IMBLEARN_IMPORT_ERROR)),
        ("ipywidgets", (ipywidgets_available, IPYWIDGETS_IMPORT_ERROR)),
        ("matplotlib", (is_matplotlib_available, MATPLOTLIB_IMPORT_ERROR)),
        ("pypdf", (is_matplotlib_available, PYPDF_IMPORT_ERROR)),
        ("reportlab", (is_reportlab_available, REPORTLAB_IMPORT_ERROR)),
        ("pandas", (is_pandas_available, PANDAS_IMPORT_ERROR)),
        ("polars", (is_polars_available, POLARS_IMPORT_ERROR)),
        ("psutil", (is_psutil_available, PSUTIL_IMPORT_ERROR)),
        ("phonemizer", (is_phonemizer_available, PHONEMIZER_IMPORT_ERROR)),
        ("plotly", (is_plotly_available, PLOTLY_IMPORT_ERROR)),
        ("pretty_midi", (is_pretty_midi_available, PRETTY_MIDI_IMPORT_ERROR)),
        ("levenshtein", (is_levenshtein_available, LEVENSHTEIN_IMPORT_ERROR)),
        ("librosa", (is_librosa_available, LIBROSA_IMPORT_ERROR)),
        ("lightgbm", (is_lightgbm_available, LIGHTGBM_IMPORT_ERROR)),
        ("protobuf", (is_protobuf_available, PROTOBUF_IMPORT_ERROR)),
        ("pyctcdecode", (is_pyctcdecode_available, PYCTCDECODE_IMPORT_ERROR)),
        ("pytesseract", (is_pytesseract_available, PYTESSERACT_IMPORT_ERROR)),
        ("rpy2", (is_rpy2_available, RPY2_IMPORT_ERROR)),
        ("rpy2_arrow", (is_rpy2_arrow_available, RPY2_ARROW_IMPORT_ERROR)),
        ("sacremoses", (is_sacremoses_available, SACREMOSES_IMPORT_ERROR)),
        (
            "pytorch_quantization",
            (is_pytorch_quantization_available, PYTORCH_QUANTIZATION_IMPORT_ERROR),
        ),
        ("seaborn", (is_seaborn_available, SEABORN_IMPORT_ERROR)),
        ...
        ("statsmodels", (is_statsmodels_available, STATSMODELS_IMPORT_ERROR)),
        ...
        ("ipywidgets", (is_ipywidgets_available, IPYWIDGETS_IMPORT_ERROR)),
        ("xgboost", (is_xgboost_available, XGBOOST_IMPORT_ERROR)),
    ]
)


def requires_backends(obj_or_name, backends):
    ...
    if isinstance(obj_or_name, str):
        ...
        name = (
            obj_or_name.__name__
            if hasattr(obj_or_name, "__name__")
            else obj_or_name.__class__.__name__
        )
...
def direct_genomicsml_import(path: str, file="__init__.py") -> ModuleType:
    """Imports biosets directly
